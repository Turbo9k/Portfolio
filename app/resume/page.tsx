        ...
        >
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm print:bg-white print:text-black print:border-gray-300 w-full hidden">
            <CardContent className="p-4 sm:p-6 md:p-8">
              <div className="text-center mb-4 sm:mb-6">
                ...
                <h2 className="text-base sm:text-lg md:text-xl text-blue-400 print:text-blue-600 mb-3 sm:mb-4">Full-Stack Web Developer</h2>
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm print:bg-white print:text-black print:border-gray-300 w-full">
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-white print:text-black flex items-center gap-2 text-lg sm:text-xl">
                <Award className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 print:text-blue-600" />
                Professional Summary
              </CardTitle>
            </CardHeader>
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm print:bg-white print:text-black print:border-gray-300 w-full">
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-white print:text-black flex items-center gap-2 text-lg sm:text-xl">
                <Code className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 print:text-blue-600" />
                Technical Skills
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 sm:p-6 pt-0">
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                <div>
                  <h4 className="font-semibold text-white print:text-black mb-2 sm:mb-3 text-xs sm:text-sm uppercase tracking-wide">Frontend</h4>
                ...
                <div>
                  <h4 className="font-semibold text-white print:text-black mb-2 sm:mb-3 text-xs sm:text-sm uppercase tracking-wide">Backend & Databases</h4>
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {[
                      "Node.js",
                      "Python",
                ...
                <div>
                  <h4 className="font-semibold text-white print:text-black mb-2 sm:mb-3 text-xs sm:text-sm uppercase tracking-wide">Tools & Technologies</h4>
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {[
                      "Git/GitHub",
                      "Vercel",
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm print:bg-white print:text-black print:border-gray-300 w-full">
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-white print:text-black flex items-center gap-2 text-lg sm:text-xl">
                <ExternalLink className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 print:text-blue-600" />
                Featured Projects
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 sm:p-6 pt-0 space-y-4 sm:space-y-6">
              <div className="border-l-2 border-blue-500/30 pl-3 sm:pl-4 print:border-blue-600">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 gap-1 sm:gap-0">
                  <h4 className="font-semibold text-white print:text-black text-base sm:text-lg break-words">Full-Stack E-Commerce Platform</h4>
                  <span className="text-xs sm:text-sm text-gray-400 print:text-gray-600 font-medium">2024</span>
                </div>
                ...
                <p className="text-xs sm:text-sm text-blue-400 print:text-blue-600 font-medium break-words">
                  Live Demo: <a href="https://ecommerce-store-mu-five.vercel.app" target="_blank" rel="noopener noreferrer" className="underline break-all">ecommerce-store-mu-five.vercel.app</a>
                </p>
              </div>

              <div className="border-l-2 border-green-500/30 pl-3 sm:pl-4 print:border-green-600">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 gap-1 sm:gap-0">
                  <h4 className="font-semibold text-white print:text-black text-base sm:text-lg break-words">Advanced Calculator Application</h4>
                  <span className="text-xs sm:text-sm text-gray-400 print:text-gray-600 font-medium">2024</span>
                </div>
                <p className="text-gray-300 print:text-gray-700 mb-3 leading-relaxed text-sm sm:text-base">
                ...
                <p className="text-xs sm:text-sm text-blue-400 print:text-blue-600 font-medium break-words">
                  GitHub: <a href="https://github.com/Turbo9k/Calculator" target="_blank" rel="noopener noreferrer" className="underline break-all">github.com/Turbo9k/Calculator</a>
                </p>
              </div>

              <div className="border-l-2 border-purple-500/30 pl-3 sm:pl-4 print:border-purple-600">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 gap-1 sm:gap-0">
                  <h4 className="font-semibold text-white print:text-black text-base sm:text-lg break-words">Enterprise Admin Dashboard</h4>
                  <span className="text-xs sm:text-sm text-gray-400 print:text-gray-600 font-medium">2024</span>
                </div>
                <p className="text-gray-300 print:text-gray-700 mb-3 leading-relaxed text-sm sm:text-base">
                ...
                <p className="text-xs sm:text-sm text-blue-400 print:text-blue-600 font-medium break-words">
                  Live Demo: <a href="https://cognivex.vercel.app" target="_blank" rel="noopener noreferrer" className="underline break-all">cognivex.vercel.app</a>
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm print:bg-white print:text-black print:border-gray-300 w-full">
            ...
            <CardContent className="p-4 sm:p-6 pt-0 space-y-4">
              <div>
                ...
                <ul className="text-gray-300 print:text-gray-700 space-y-2 ml-3 sm:ml-4 text-sm sm:text-base">
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm print:bg-white print:text-black print:border-gray-300 w-full">
            ...
            <CardContent className="p-4 sm:p-6 pt-0">
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  <h4 className="font-semibold text-white print:text-black mb-2 sm:mb-3 text-xs sm:text-sm uppercase tracking-wide">Technical Capabilities</h4>
                  <ul className="text-gray-300 print:text-gray-700 space-y-2 sm:space-y-2.5 text-sm sm:text-base">
                    <li className="flex items-start gap-2">
                ...
                <div>
                  <h4 className="font-semibold text-white print:text-black mb-2 sm:mb-3 text-xs sm:text-sm uppercase tracking-wide">Professional Attributes</h4>
                  <ul className="text-gray-300 print:text-gray-700 space-y-2 sm:space-y-2.5 text-sm sm:text-base">
                    <li className="flex items-start gap-2">
